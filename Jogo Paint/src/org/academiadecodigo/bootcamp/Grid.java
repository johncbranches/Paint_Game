...
public class Grid {
    ...
    private int nrCols = 20;
    private int nrRows = 20;
    ...
    public void init() {
        ...
        backgroundWhite = new Rectangle(10, 10, 842, 1200);
        backgroundWhite.setColor(Color.WHITE);
        backgroundWhite.fill();

        Text text = new Text(50, 875, "To move, press the Arrow Keys.     To paint, keep the space bar pressed.");
        text.draw();

        Text text2 = new Text(50, 908, "To change the color, press M.  To save, press S.  To load, press L.   To exit, press E.");
        text2.draw();

        background = new Rectangle(10, 10, 842, 842);
    ...
    public void drawIt() {
        if (draw) {
            if (gridColor[currentPos[0]][currentPos[1]].equals("White")) {
